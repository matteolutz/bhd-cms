...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create bhd-cms-9bd9
  fly apps create bhd-cms-9bd9-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app bhd-cms-9bd9
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app bhd-cms-9bd9-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'bhd-cms-9bd9-staging' does not match app name in config file 'bhd-cms-9bd9'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name bhd-cms-9bd9-db
  fly postgres attach --app bhd-cms-9bd9 bhd-cms-9bd9-db

  fly postgres create --name bhd-cms-9bd9-staging-db
  fly postgres attach --app bhd-cms-9bd9-staging bhd-cms-9bd9-staging-db
  ```
